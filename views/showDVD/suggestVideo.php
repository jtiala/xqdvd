					...
					<div id="dvd-suggest" class="box">
						...
						<form class="form-horizontal" action="<?= SITE_URL . '/' . $URL[0] . '/' . urlencode($URL[1]) ?>/suggest" method="post">
							...
							<div class="form-group">
								<label for="suggestedBy" class="col-sm-4 col-lg-3 control-label">Ehdottaja</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label for="title" class="col-sm-4 col-lg-3 control-label">Videon nimi</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label for="url" class="col-sm-4 col-lg-3 control-label">Videon URL</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" id="url" name="url" value="<?= empty($data['url']) ? null : $data['url']?>">
								</div>
								<div class="col-sm-1"><span class="label label-danger" data-toggle="tooltip" data-placement="top" title="Vaadittu kenttä">*</span>&nbsp;<span class="label label-info" data-toggle="tooltip" data-placement="top" title="Linkki videon YouTube-sivulle">?</span></div>
							</div>

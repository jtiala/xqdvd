					...
					<div id="add-dvd" class="box">
						...
						<form class="form-horizontal" action="<?= SITE_URL ?>/create" method="post">
							...
							<div class="form-group">
								<label for="title" class="col-sm-4 col-xs-12 control-label">DVD:n nimi</label>
								<div class="col-sm-6 col-xs-10">
									<input type="text" class="form-control" id="title" name="title" value="<?= empty($data['title']) ? null : $data['title']?>">
								</div>
								<div class="col-sm-2"><span class="label label-danger" data-toggle="tooltip" data-placement="top" title="Vaadittu kenttä">*</span></div>
							</div>

							<div class="form-group">
								<label for="author" class="col-sm-4 col-xs-12 control-label">Tekijä</label>
								<div class="col-sm-6 col-xs-10">
							...
							<div class="form-group">
								<label for="email" class="col-sm-4 col-xs-12 control-label">Tekijän email</label>
								<div class="col-sm-6 col-xs-10">
									<input type="email" class="form-control" id="email" name="email" value="<?= empty($data['email']) ? null : $data['email']?>">
								</div>
								<div class="col-sm-2"><span class="label label-danger" data-toggle="tooltip" data-placement="top" title="Vaadittu kenttä">*</span>&nbsp;<span class="label label-info" data-toggle="tooltip" data-placement="top" title="Käyetään DVD:n admin-linkin lähetykseen">?</span></div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-4 col-xs-12 control-label">DVD:n tila</label>
								<div class="col-sm-6 col-xs-10">
								...
								<div class="col-sm-2"><span class="label label-info" data-toggle="tooltip" data-placement="top" title="Epäaktiiviseen DVD:hen pääsee käsiksi vain admin-linkillä">?</span></div>
							</div>

							<div class="form-group">
								<label for="showFrontpage" class="col-sm-4 col-xs-12 control-label">Näytä etusivulla</label>
								<div class="col-sm-6 col-xs-10">
							...
							<div class="form-group">
								<label for="description" class="col-sm-4 col-xs-12 control-label">Kuvaus</label>
								<div class="col-sm-6 col-xs-10">

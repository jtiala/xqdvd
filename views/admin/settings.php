					...
					<div id="add-dvd" class="box">
						...
						<form class="form-horizontal" action="<?= SITE_URL . '/' . $dvd . '/' . $url . '/' . $adminHash ?>/settings" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									<label class="radio-inline">
										<input type="radio" name="status" value="published" <?= ! empty($data['status']) && $data['status'] == 'published' ? 'checked="checked"' : null ?>> Julkaistu
									</label>
								</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-4 col-lg-offset-3 col-sm-8">
									...
									<a class="btn btn-danger" href="<?= SITE_URL . '/' . $dvd . '/' . $url . '/' . $adminHash ?>/deleteDVD">Poista DVD</a>
								</div>
							</div>
						</form>
					</div>
